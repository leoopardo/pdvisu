import{j as d}from"./jsx-runtime-QvZ8i92b.js";import{u as w,a as u,P as h}from"./provideTheme-DWp2NUCK.js";import{u as $,R as g}from"./row-CpXKsyvR.js";import"./index-uubelm5h.js";import"./themeProvider-Bzcnva43.js";const v={xs:576,sm:767,md:991,lg:1199,xl:1600},T=w.div`
  height: fit-content;
  ...
  ${({xs:e,sm:l,md:a,lg:n,xl:r,span:t,gutter:i,childCount:m})=>r&&u`
    ...
    `}
`,y=({children:e,...l})=>{const{childCount:a,gutter:n}=$();return console.log(a),d.jsx(T,{gutter:n,childCount:a,...l,children:e})};y.__docgenInfo={description:"",methods:[],displayName:"Col",props:{children:{required:!1,tsType:{name:"union",raw:"ReactChild | string | any",elements:[{name:"ReactChild"},{name:"string"},{name:"any"}]},description:""},span:{required:!1,tsType:{name:"union",raw:`| 1
| 2
| 3
| 4
| 5
